						...
						<v-expansion-panel-text>
							<ol class="pl-3 columnAlignCenter ga-3">
								<li>
									...
									>
									with our Outsourcing Specialist and give us
									an overview of everything you’re looking for
									in a VA.
								</li>
								<li>
									<b>Strategy Meeting</b> - Within 24 hours of
									the call, our HR team will schedule a
									virtual meeting to better understand the
									tasks to outsource and your company culture.
								</li>
								<li>
									<b>Virtual Assistant Recruitment</b> - We
									will start interviewing the candidates that
									meet your requirements and create a
									shortlist of options for you. This process
									usually takes around 1-2 weeks.
								</li>
								<li>
									<b>Hiring & Onboarding</b> - When you’re
									ready, we’ll hire the Virtual Assistant and
									you will start working with them, with the
									support of your Customer Success Agent to
									assist you in the initial ‘nesting period’
									to avoid any miscommunications or
									misunderstandings.
								</li>
								<li>
									<b>Regular check-ins</b> - Our team will
									also have regular meetings and performance
									reviews and provide company benefits for
									your Virtual Assistant to ensure their
									happiness and to get all your tasks done the
									way you want them.
								</li>
							</ol>
						</v-expansion-panel-text>
					...
					>
						<v-expansion-panel-text>
							<ul class="pl-2 d-flex flex-column ga-3">
								...
								<li>
									<b>The long answer:</b> When you start
									working with a Virtual Assistant or Virtual
									Professional from Iconic Assistants, you are
									not hiring our VAs directly, you are hiring
									our company’s services (a US company), and
									like with any other service, no taxes are
									due. Our company handles all the paperwork
									for hiring our VAs as foreign independent
									contractors.
								</li>
								<li>
									In other words, 1) You are not hiring people
									from the US as employees, and 2) You are not
									hiring VAs in the US, you are hiring our
									services, so you don’t have to worry about
									any tax forms.
								</li>
							</ul>
						</v-expansion-panel-text>
...
export default {
	...
	methods: {
		...
		async sendEmail(id) {
			...
			await emailjs
				.send("iconic_email", "template_fm1n94g", emailData)
				.then(
					(response) => {
						window.location.reload();
					},
