<template>
  ...
  <!-- Step 1 -->
  <section class="stepDesktop skyRadioactive">
  ...
  <!-- Step 2 -->
  <section class="stepDesktop reversed radioactiveWaves">
    <div class="stepDesktopBody columnAlignCenter ga-1">
  ...
  <!-- Step 3 -->
  <section class="stepDesktop radioactiveSky">
    <div class="stepDesktopBody columnAlignCenter ga-1">
  ...
  <!-- Step 4 -->
  <section class="stepDesktop reversed skyRadioactiveWaves">
    <div class="stepDesktopBody columnAlignCenter ga-1">
