				...
				>
					<div class="heroTitle">
						<h1
							...
							class="text-start text-midnight mb-5"
						>
						...
						<p
							v-motion="scrollBottom"
							class="w-100 pMedium text-start"
						>
							Recruitment made simple, cost effective and
							scalable. Hire top 1% of Executive and Customer
							Service Assistants.
						</p>
						<div
							ref="formContainer"
							id="form-container"
							class="form bg-white rounded-xl pa-5 elevation-3 mt-5"
						></div>
					</div>
