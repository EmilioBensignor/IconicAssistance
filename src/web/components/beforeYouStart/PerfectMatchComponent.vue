        ...
        <div class="perfectMatch columnAlignCenter ga-14 mt-5 py-5">
          <div
            ...
            <p class="text-white mt-3 mb-6">
              Our highly qualified HR team meticulously assesses the unique
              skills you require. We ensure a perfect fit.
            </p>
            <img
              src="@/web/assets/images/beforeYouStart/Tailored-Skill.png"
              alt="Tailored Skill"
              class="shadow-15"
              width="25%" />
          </div>
          <div
            ...
            <img
              src="@/web/assets/images/beforeYouStart/Industry-Insights.png"
          ...
          <div
            ...
            <p class="text-white mt-3 mb-6">
              We take into account the depth of experience needed for your
              tasks, with seamless integration into your workflow.
            </p>
            <img
              src="@/web/assets/images/beforeYouStart/Experiental-Synergy.png"
          ...
          <div
            ...
            <img
              src="@/web/assets/images/beforeYouStart/Personalized-Collaboration.png"
