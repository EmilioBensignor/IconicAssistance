            ...
            <v-window-item value="full-time">
              <div class="flexCenter px-4 ga-1">
                <img
                  ...
                  width="25%"
                  src="@/web/assets/images/pricing/full-time-remote-talent.png"
            ...
            <v-window-item value="part-time">
              <div class="px-4 flexCenter ga-1">
                <img
                  class="shadow-15 mt-6 mb-2"
                  width="25%"
                  src="@/web/assets/images/pricing/part-time-remote-talent.png"
            ...
            <v-window-item value="build-team">
              <div class="px-4 flexCenter ga-1">
                <img
                  class="shadow-15 mt-6 mb-2"
                  width="25%"
                  src="@/web/assets/images/pricing/build-your-iconic-team.png"
