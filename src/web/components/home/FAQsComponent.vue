              ...
              <v-expansion-panel-text>
                <ol class="pl-3 columnAlignCenter ga-3">
                  ...
                  <li>
                    ...
                    notify you when we find the perfect match. This process
                    usually takes around 5 to 7 days.
                  </li>
                  <li>
            ...
            <v-expansion-panel
              ...
              <v-expansion-panel-text>
                <p>
                  ...
                  overwhelming. It might be time to consider a executive
                  assistant if you find yourself:
                </p>
                <ol class="my-3 pl-5">
                  <li>
                ...
                <p>
                  ...
                  perfect time to consider hiring a executive assistant. They
                  can help you regain control, reduce stress, and refocus on
