      ...
      <div class="columnAlignCenter">
        <div class="howWeWork columnAlignCenter">
          <div class="columnAlignCenter howWeWorkRight">
            ...
            <router-link
              class="buttonDesktop secondaryButton elevation-5 mb-5"
              :to="'/how-we-hire'">
          ...
          <div
            ...
            <img
              ...
              src="@/web/assets/images/aboutUs/Professional-Executive-Assistant.png"
            ...
            <div
              ...
              <p class="text-radioactive text-center">
                We employ cutting-edge tools and technologies to stay current
                with the latest developments in the industry and adhere to the
                best practices.
              </p>
            </div>
          </div>
        ...
        <router-link
          class="buttonMobile secondaryButton elevation-5 mb-5"
          :to="'/how-we-hire'">
          Learn About How We Hire
        </router-link>
        <div class="divTools columnAlignCenter">
          <p v-motion="scrollBottom" class="tools my-5">
