export const industries = [
  {
    ...
    subtitle: "Iconic Assistants' Executive Professionals are essential partners for entrepreneurs. Specializing in executive administration, digital marketing, and project management, our VAs provide the support needed for strategic growth. Choose Iconic Assistants to empower your business with efficient and tailored assistance.",
    description: "Executive assistants handle exec tasks, manage projects, and recruit.",
    vaTypes: [
      {
      ...
      },
      {
        ...
        alt: "Project Management Executive Assistant",
  ...
  },
  {
    ...
    subtitle: "In the legal field, Iconic Assistants' Executive Professionals redefine support. Expertise in administrative tasks, data entry, customer service, and project management makes our VAs an invaluable asset. Optimize your legal practice with Iconic Assistants' VAs for efficient and dedicated assistance.",
    description: "EAs organize documents, draft letters, handle cases, etc.",
    vaTypes: [
      {
        va: "Administration",
      ...
      },
      {
        ...
        alt: "Customer Service Executive Assistant",
  ...
  },
  {
    ...
    subtitle: "Iconic Assistants' Executive Professionals redefine efficiency in healthcare, seamlessly managing appointments, ensuring accurate data entry, and providing essential administrative support. Elevate patient care by choosing our VAs for streamlined and impactful healthcare operations.",
    description: "EAs book doctors' appointments, do data entry, market, sell, translate, etc.",
    vaTypes: [
      {
  ...
  },
  {
    ...
    subtitle: "In the non-profit sector, Iconic Assistants' Executive Professionals shine in administrative support, donor database management, and impactful social media engagement. Elevate your non-profit's efficiency and focus on your mission with our dedicated VAs.",
    description: "EAs reach out to donors, manage fundraisers, design marketing collateral, etc.",
    vaTypes: [
      {
        va: "Administration",
        img: "main/Administration-Executive-Assistant.png",
  ...
  },
  {
    ...
    subtitle: "For seamless property management, trust Iconic Assistants' Executive Professionals. Specializing in administrative tasks, customer service, data entry, and project management, our VAs optimize workflows. Choose Iconic Assistants for a tailored and efficient support team in property management.",
    description: "EAs oversee contractors, schedule appointments, manage new leads, etc.",
    vaTypes: [
      {
        va: "Administration",
        img: "main/Administration-Executive-Assistant.png",
  ...
  },
  {
    ...
    subtitle: "In real estate, Iconic Assistants' Executive Professionals redefine efficiency. From appointment setting and data entry to customer service and sales support, our VAs streamline operations. Choose Iconic Assistants for a dynamic and dedicated team that enhances your real estate endeavors.",
    description: "EAs arrange viewings, manage documents, offer customer support, etc.",
    vaTypes: [
      {
        va: "Appointment Setting",
        img: "main/Appointment-Setting-Executive-Assistant.png",
  ...
  },
  {
    ...
    subtitle: "In the non-profit sector, Iconic Assistants' Executive Professionals shine in administrative support, donor database management, and impactful social media engagement. Elevate your non-profit's efficiency and focus on your mission with our dedicated VAs.",
    description: "EAs contact donors, manage fundraisers, create marketing collateral, etc.",
    vaTypes: [
      {
        va: "Customer Support",
        img: "main/Customer-Support-Executive-Assistant.png",
  ...
  },
  {
    ...
    subtitle: "In the tech and software industry, Iconic Assistants' Executive Professionals are your efficiency partners. Specializing in project management, data entry, customer service, and administrative tasks, our VAs seamlessly integrate into your operations. Optimize your workflow with Iconic Assistants' VAs for a tech-savvy and adaptable support team.",
    description: "EAs lead onboardings, offer customer support, manage client success, etc.",
    vaTypes: [
      {
        va: "Project Management",
        img: "main/Project-Management-Executive-Assistant.png",
