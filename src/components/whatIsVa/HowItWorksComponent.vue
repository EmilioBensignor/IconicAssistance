<template>
  <section class="radioactiveSkyWaves">
    ...
    <div class="w-75 keyMobile">
      <img src="@/assets/images/whatIsVa/Iconic-Assistants-Key-Benefits.jpg" alt="Iconic Assistants Key Benefits"
        class="my-5" v-motion="scrollBottom" width="75%" />
    </div>
    <div class="w-75 keyDesktop">
      <img src="@/assets/images/whatIsVa/Iconic-Assistants-Key-Benefits-Desktop.png"
        alt="Iconic Assistants Key Benefits" class="my-5" v-motion="scrollBottom" width="75%" />
    </div>
    <div v-motion="scrollBottom"
      ...
      <router-link class="primaryButton elevation-5 mt-5" :to="'/services'">Explore Our Services</router-link>
    </div>
  </section>
</template>
