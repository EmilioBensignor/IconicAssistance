<template>
  <section class="skyRadioactive">
    ...
    <div class="columnAlignCenter ga-14 mt-5 py-5">
      <div class="w-75 columnAlignCenter border-lb rounded-bs-xl py-3 shadow-3">
      ...
      <div class="w-75 columnAlignCenter border-rb rounded-be-xl py-3 shadow-3">
      ...
      <div class="w-75 columnAlignCenter border-lt rounded-ts-xl py-3 shadow-3">
      ...
      <div class="w-75 columnAlignCenter border-rt rounded-te-xl py-3 shadow-3">
