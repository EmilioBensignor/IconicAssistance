<template>
  <section class="skyRadioactive opportunities">
    <div class="opportunitiesLeft w-75 columnAlignCenter">
      ...
      <div class="w-75 vaMobile">
        <img src="@/assets/images/beforeYouStart/Outsource-Remote-Talent.png" alt="Outsource Remote Talent"
          class="rounded-circle elevation-5 my-5" v-motion="scrollBottom" width="100%" />
      </div>
      ...
      <div class="vaOpportunities d-flex ga-3 my-5">
        <ul v-motion="scrollBottom" class="column ga-3 text-white font-weight-bold">
