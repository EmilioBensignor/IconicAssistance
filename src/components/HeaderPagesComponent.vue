  ...
  <nav>
    <v-app-bar elevation="0" app class="bg-white d-flex align-center py-1">
      ...
      <div class="menuDesktop">
        ...
        <v-btn class="btnNav" color="radioactive" :to="'/pricing'">
          Pricing
        </v-btn>
    ...
    <v-navigation-drawer v-model="showMenu" app class="mt-2">
      <v-list class="pt-5" tag="ul">
        <router-link class="bg-radioactive rounded-xl font-weight-medium text-decoration-none ml-6 px-15 py-2"
          :to="'/contact-us'">Book a Call</router-link>
