  ...
  <section class="skyRadioactive">
    <div class="content">
      <div class="columnAlignCenter">
        ...
        <div class="faqHome columnAlignCenter ga-4">
          <v-expansion-panels
            ...
            <v-expansion-panel
              ...
              <v-expansion-panel-text>
                ...
                more than just an outsourcing company; we're your dedicated ally
                in achieving your business goals. With a team of experts
                committed to quality, affordability, and customization, we offer
                a wide range of services tailored to your unique needs. Our
                client-centric approach, open communication, and unwavering
                dedication set us apart. Choose Iconic Assistants, and
                experience excellence, innovation, and trust in every
                partnership. Elevate your business. Your success is our priority
              </v-expansion-panel-text>
            </v-expansion-panel>
          </v-expansion-panels>
                  ...
                  <v-expansion-panel-text>
                    <ol class="pl-3 columnAlignCenter ga-3">
                      <li>
                        ...
                        >
                        with our Outsourcing Specialist and give us an overview
                        of everything you’re looking for in a VA.
                      </li>
                      <li>
                        <b>Strategy Meeting</b> - Within 24 hours of the call,
                        our HR team will schedule a virtual meeting to better
                        understand the tasks to outsource and your company
                        culture.
                      </li>
                      <li>
                        <b>Virtual Assistant Recruitment</b> - We will start
                        interviewing the candidates that meet your requirements
                        and create a shortlist of options for you. This process
                        usually takes around 1-2 weeks.
                      </li>
                      <li>
                        <b>Hiring & Onboarding</b> - When you’re ready, we’ll
                        hire the Virtual Assistant and you will start working
                        with them, with the support of your Customer Success
                        Agent to assist you in the initial ‘nesting period’ to
                        avoid any miscommunications or misunderstandings.
                      </li>
                      <li>
                        <b>Regular check-ins</b> - Our team will also have
                        regular meetings and performance reviews and provide
                        company benefits for your Virtual Assistant to ensure
                        their happiness and to get all your tasks done the way
                        you want them.
                      </li>
                    </ol>
                  </v-expansion-panel-text>
                  ...
                  <v-expansion-panel-text>
                    <ul class="pl-2 d-flex flex-column ga-3">
                      ...
                      <li>
                        ...
                        hiring our company’s services (a US company), and like
                        with any other service, no taxes are due. Our company
                        handles all the paperwork for hiring our VAs as foreign
                        independent contractors.
                      </li>
                      <li>
                        In other words, 1) You are not hiring people from the US
                        as employees, and 2) You are not hiring VAs in the US,
                        you are hiring our services, so you don’t have to worry
                        about any tax forms.
                      </li>
                    </ul>
                  </v-expansion-panel-text>
            ...
            <div class="w-100 columnAlignCenter ga-4">
              <v-expansion-panels v-motion="scrollBottom" class="faqWrapper">
                <v-expansion-panel
                  ...
                  <v-expansion-panel-text>
                    <p>
                      Sometimes, managing the demands of work and life can
                      become overwhelming. It might be time to consider a
                      virtual assistant if you find yourself:
                    </p>
                    <ol class="my-3 pl-5">
                      <li>
                        <span class="font-weight-bold">Overloaded</span>— If
                        you're juggling too many tasks and struggling to keep up
                        with your core responsibilities.
                      </li>
                      <li>
                        <span class="font-weight-bold">Time - Strapped</span> —
                        When you don't have time for strategic planning and
                        growth due to constant administrative tasks.
                      </li>
                      <li>
                        <span class="font-weight-bold">Feeling Stressed</span> —
                        If you're frequently stressed or anxious about looming
                        deadlines and mounting to-do lists.
                      </li>
                      <li>
                        <span class="font-weight-bold"
                          >Missing Opportunities</span
                        >— When you're missing out on opportunities because you
                        can't manage everything effectively.
                      </li>
                      <li>
                        <span class="font-weight-bold"
                          >Productivity Decline</span
                        >
                        — If your productivity and efficiency are suffering due
                        to an excess of small, time-consuming tasks.
                      </li>
                    </ol>
                    <p>
                      If you resonate with any of these situations, it might be
                      the perfect time to consider hiring a virtual assistant.
                      They can help you regain control, reduce stress, and
                      refocus on what truly matters for your success.
                    </p>
                  </v-expansion-panel-text>
                </v-expansion-panel>
              </v-expansion-panels>
              <v-expansion-panels v-motion="scrollBottom" class="faqWrapper">
                <v-expansion-panel
                  ...
                  <v-expansion-panel-text>
                    You can outsource almost anything to a Virtual Assistant as
                    long as you’re clear with what, when and how you want things
                    done (we can help you with that!). Here are
                    <router-link class="FAQLink" :to="'/types-of-vas'"
                      >examples of what our Virtual Assistants can
                      do.</router-link
                    >
                  </v-expansion-panel-text>
                </v-expansion-panel>
