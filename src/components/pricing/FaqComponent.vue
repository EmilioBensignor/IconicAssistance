<template>
  <section class="radioactiveSkyWaves">
    ...
    <div class="faq w-75 columnAlignCenter ga-2 my-5">
      <v-expansion-panels v-for="(item, index) in faq" :key="index" v-motion="scrollBottom" class="faqWrapper mt-3">
        <v-expansion-panel class="elevation-2" :title="item.title" :text="item.text">
        </v-expansion-panel>
      </v-expansion-panels>
    </div>
    <router-link class="w-75 secondaryButton mt-5 elevation-5" :to="'/faq'">View more Frequently Asked
    ...
    return {
      faq: [
        ...
        },
        {
          ...
          text: "From the first meeting, it takes approximately 10 to 20 business days to find, interview and qualify the right candidates options for you and your business.",
        },
      ],
    };
  },
